...
//                initUI(SalesInvoiceService.class, "Sales", InvoiceUI.class, PostedInvoicesListUI.class);
        ...
        ((AppMainWindow)SystemStatic.getMainWindow()).addMenu("InventoryJournalUI", InventoryJournalUI.class,InventoryJournalService.class);
        ((AppMainWindow)SystemStatic.getMainWindow()).addMenu("InventoryJournalListUI", CategoryListUI.class,CategoryService.class);
            }
        });
