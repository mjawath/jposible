 ...
 * @author yy
 */
public class InvoiceCategory extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        titem1 = new com.components.custom.TextFieldWithPopUP<Item>();
        ...
        tqty.setBounds(350, 10, 50, 30);

        tprice.setText("Price");
        tpnlLineDetail.add(tprice);
        tprice.setBounds(410, 10, 90, 30);

        titem.setText("Item");
        tpnlLineDetail.add(titem);
        titem.setBounds(190, 10, 130, 30);

        tline.setText("Line Amount");
        tpnlLineDetail.add(tline);
        tline.setBounds(510, 10, 104, 30);

        titem1.setText("Category");
        tpnlLineDetail.add(titem1);
        titem1.setBounds(20, 10, 120, 30);

        add(tpnlLineDetail);
        tpnlLineDetail.setBounds(20, 120, 670, 40);
        add(controlPanel1);
    ...
    private com.components.custom.TextFieldWithPopUP<Item> titem1;
